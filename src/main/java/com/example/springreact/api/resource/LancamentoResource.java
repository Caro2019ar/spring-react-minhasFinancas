...
import com.example.springreact.Service.impl.LancamentoServiceImpl;
import com.example.springreact.api.dto.LancamentoDTO;
...
import com.example.springreact.model.enums.TipoLancamento;
...
public class LancamentoResource {
    ...
    public ResponseEntity buscar(
            //Outra forma de passar todos parametros por MAP com todos opcionais: buscar(@RequestParam java.util
    ...
    public ResponseEntity atualizar(@PathVariable("id") Long id, @RequestBody LancamentoDTO dto){
        ...
        }).orElseGet(()-> new ResponseEntity("Lancamento não encontrdo na base de Dados", HttpStatus.BAD_REQUEST));
    ...
    private Lancamento converter(LancamentoDTO dto){
        ...
        Usuario usuario = usuarioService.obterPorId(dto.getUsuario()).orElseThrow(()->new RegraNegocioException(
